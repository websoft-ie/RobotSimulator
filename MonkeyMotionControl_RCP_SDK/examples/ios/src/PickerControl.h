...
@class PickerControl;
@protocol PickerControlDelegate<NSObject>
@optional
...
@interface PickerControl : UIView<PickerTextFieldDelegate, TextInputViewDelegate, UIPickerViewDataSource, UIPickerViewDelegate>

@property (weak, nonatomic) id<PickerControlDelegate> delegate;
@property (assign, nonatomic) rcp_param_t paramID;
@property (assign, nonatomic) BOOL ignoreCameraListUpdates;
