...
@class MultiActionView;
@protocol MultiActionViewDelegate<NSObject>
@required
- (void)multiActionViewReadyToOpen:(MultiActionView *)multiActionView;
@end

@interface MultiActionView : UIView<UITableViewDelegate, UITableViewDataSource>

@property (weak, nonatomic) id<MultiActionViewDelegate> delegate;
