...
@interface MenuTree : UIView<UITableViewDelegate, UITableViewDataSource, MenuTableViewCellDelegate, MenuListViewDelegate, CurveViewDelegate, MultiActionViewDelegate>

@property (assign, nonatomic) BOOL menuTreeRequested;
