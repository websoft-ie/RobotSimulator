...
#define UDP_DISCOVERY_SLEEP_TIME_US 1000
#define READ_TIMEOUT_S 5.0
#define CONNECTION_ERROR_TIMEOUT_S 3.5
#define UDP_LISTEN_TIMEOUT 2
#define SLIDER_UPDATE_DELAY_S 2.0
#define ACTIVITY_INDICATOR_DELAY_S 0.2

typedef enum
{
    SEND_VALUE_TYPE_INT,
    SEND_VALUE_TYPE_UINT,
    SEND_VALUE_TYPE_STR
} send_value_type_t;

@interface RCPUtil : NSObject
