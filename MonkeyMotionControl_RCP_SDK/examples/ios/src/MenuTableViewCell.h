...
@interface MenuTableViewCell : UITableViewCell<PickerControlDelegate, SliderControlDelegate, TextControlDelegate>

@property (weak, nonatomic) id<MenuTableViewCellDelegate> delegate;
@property (assign, nonatomic) BOOL hasFocus;
@property (assign, nonatomic) BOOL orderedListViewRequested;
@property (assign, nonatomic) BOOL curveViewRequested;
@property (assign, nonatomic) int timecode;         // only applicable for timecode leafs
@property (assign, nonatomic) uint32_t ipAddress;   // only applicable for ip address leafs
