...
@interface RCPList : NSObject

@property (assign, nonatomic) rcp_param_t paramID;
@property (assign, nonatomic) size_t currentRow;
@property (assign, nonatomic) int minValue;
@property (assign, nonatomic) int maxValue;
@property (assign, nonatomic) BOOL minValueValid;
@property (assign, nonatomic) BOOL maxValueValid;
@property (assign, nonatomic) BOOL updateOnlyOnClose;
