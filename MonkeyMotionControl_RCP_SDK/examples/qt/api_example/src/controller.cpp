...
void Controller::initialize()
{
    ...
    i = 0;
    param_t params[100];
    params[i++] = (param_t){RCP_PARAM_SENSOR_FRAME_RATE, UI_TYPE_COMBO};
    params[i++] = (param_t){RCP_PARAM_ISO, UI_TYPE_COMBO};
    params[i++] = (param_t){RCP_PARAM_APERTURE, UI_TYPE_COMBO};
    params[i++] = (param_t){RCP_PARAM_EXPOSURE_INTEGRATION_TIME, UI_TYPE_COMBO};
    params[i++] = (param_t){RCP_PARAM_COLOR_TEMPERATURE, UI_TYPE_COMBO};
    params[i++] = (param_t){RCP_PARAM_RECORD_FORMAT, UI_TYPE_COMBO};
    params[i++] = (param_t){RCP_PARAM_REDCODE, UI_TYPE_COMBO};
    params[i++] = (param_t){RCP_PARAM_SATURATION, UI_TYPE_SLIDER};
    params[i++] = (param_t){RCP_PARAM_CONTRAST, UI_TYPE_SLIDER};
    params[i++] = (param_t){RCP_PARAM_BRIGHTNESS, UI_TYPE_SLIDER};
    params[i++] = (param_t){RCP_PARAM_EXPOSURE_COMPENSATION, UI_TYPE_SLIDER};
    params[i++] = (param_t){RCP_PARAM_RED_GAIN, UI_TYPE_SLIDER};
    params[i++] = (param_t){RCP_PARAM_GREEN_GAIN, UI_TYPE_SLIDER};
    params[i++] = (param_t){RCP_PARAM_BLUE_GAIN, UI_TYPE_SLIDER};
    params[i++] = (param_t){RCP_PARAM_FLUT, UI_TYPE_SLIDER};
    params[i++] = (param_t){RCP_PARAM_SHADOW, UI_TYPE_SLIDER};
    params[i++] = (param_t){RCP_PARAM_SLATE_SCENE, UI_TYPE_TEXT_FIELD};
