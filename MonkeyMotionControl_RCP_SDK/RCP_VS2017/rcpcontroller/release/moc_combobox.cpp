...
QT_MOC_LITERAL(1, 9, 6), // "opened"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 6) // "closed"

    },
    "ComboBox\0opened\0\0closed"
};
...
void ComboBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ComboBox::opened)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ComboBox::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ComboBox::closed)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ComboBox::opened()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void ComboBox::closed()
{
