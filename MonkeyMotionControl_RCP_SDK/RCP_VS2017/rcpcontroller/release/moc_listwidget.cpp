...
#include <memory>
#include "../../../common/qt/src/listwidget.h"
...
QT_MOC_LITERAL(1, 11, 12), // "itemSelected"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 16), // "QListWidgetItem*"
QT_MOC_LITERAL(4, 42, 4), // "item"
QT_MOC_LITERAL(5, 47, 13) // "itemConfirmed"

    },
    "ListWidget\0itemSelected\0\0QListWidgetItem*\0"
    "item\0itemConfirmed"
};
...
void ListWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->itemSelected((*reinterpret_cast< QListWidgetItem*(*)>(_a[1]))); break;
        case 1: _t->itemConfirmed((*reinterpret_cast< QListWidgetItem*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ListWidget::*)(QListWidgetItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ListWidget::itemSelected)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ListWidget::*)(QListWidgetItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ListWidget::itemConfirmed)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ListWidget::itemSelected(QListWidgetItem * _t1)
{
...
// SIGNAL 1
void ListWidget::itemConfirmed(QListWidgetItem * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
