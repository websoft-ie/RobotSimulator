/****************************************************************************
** Meta object code from reading C++ file 'listdata.h'
**
...
#error "The header file 'listdata.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ListData_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject ListData::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_ListData.data,
    qt_meta_data_ListData,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ListData::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ListData.stringdata0))
